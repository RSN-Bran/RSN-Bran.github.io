...
pokemonArray[10] = new pokemon("011", "", "Metapod", "", "", "", "", "", "025", "z", "z", "z", "Central: 024", "018");
pokemonArray[11] = new pokemon("012", "", "Butterfree", "", "", "", "", "", "026", "z", "z", "z", "Central: 025", "019");
pokemonArray[12] = new pokemon("013", "", "Weedle", "", "", "", "", "", "027", "z", "z", "z", "Central: 026", "z");
pokemonArray[13] = new pokemon("014", "", "Kakuna", "", "", "", "", "", "028", "z", "z", "z", "Central: 027", "z");
pokemonArray[14] = new pokemon("015", "", "Beedrill", "", "", "", "", "", "029", "z", "z", "z", "Central: 028", "z");    
pokemonArray[15] = new pokemon("016", "", "Pidgey", "", "", "", "", "", "010", "z", "z", "z", "Central: 017", "z");
...
pokemonArray[18] = new pokemon("019", "", "Rattata", "", "", "", "", "", "017", "z", "z", "059", "z", "015");
...
pokemonArray[25] = new pokemon("026", "", "Raichu", "", "", "", "", "", "023", "164", "105", "z", "Central: 037", "026");
...
pokemonArray[32] = new pokemon("033", "✓", "Nidorino", "Neatoreeno!", "Hordes", 208, 158, "Shiny/nidorino.gif", "099", "z", "z", "z", "Coastal: 105", "z");
pokemonArray[33] = new pokemon("034", "", "Nidoking", "", "", "", "", "", "100", "z", "z", "z", "Coastal: 106", "z");
...
pokemonArray[103] = new pokemon("104", "", "Cubone", "", "", "", "", "", "208", "z", "z", "z", "Coastal: 060", "163");
...
pokemonArray[277] = new pokemon("278", "✓", "Wingull", "Peeko", "Hordes", 31, 55, "Shiny/wingull.gif", "z", "027", "119", "212", "Coastal: 117", "040");
pokemonArray[278] = new pokemon("279", "", "Pelipper", "", "", "", "", "", "z", "028", "120", "213", "Coastal: 118", "041");
...
pokemonArray[327] = new pokemon("328", "", "Trapinch", "", "", "", "", "", "z", "121", "z", "121", "Mountain: 003", "235");
...
pokemonArray[387] = new pokemon("388", "", "Grotle", "", "", "", "", "", "z", "z", "002", "z", "z", "z");
...
pokemonArray[418] = new pokemon("419", "", "Floatzel", "", "", "", "", "", "z", "z", "057", "150", "Mountain: 059", "z");
...
pokemonArray[425] = new pokemon("426", "", "Drifblim", "", "", "", "", "", "z", "z", "066", "209", "Coastal: 001", "065");
...
pokemonArray[519] = new pokemon("520", "", "Tranquill", "", "", "", "", "", "z", "z", "z", "015", "z", "z");
...
pokemonArray[523] = new pokemon("524", "✓", "Roggenrola", "Elvis", "Hordes", 98, 123, "Shiny/roggenrola.gif", "z", "z", "z", "068", "z", "z");
pokemonArray[524] = new pokemon("525", "", "Boldore", "", "", "", "", "", "z", "z", "z", "069", "z", "z");
pokemonArray[525] = new pokemon("526", "", "Gigalith", "", "", "", "", "", "z", "z", "z", "070", "z", "z");
...
pokemonArray[545] = new pokemon("546", "", "Cottonee", "", "", "", "", "");
pokemonArray[546] = new pokemon("547", "", "Whimsicott", "", "", "", "", "");
pokemonArray[547] = new pokemon("548", "", "Petilil", "", "", "", "", "");
pokemonArray[548] = new pokemon("549", "", "Lilligant", "", "", "", "", "");
pokemonArray[549] = new pokemon("550", "", "Basculin", "", "", "", "", "");
pokemonArray[550] = new pokemon("551", "✓", "Sandile", "Sangator", "Friend Safari", 238, 240, "Shiny/sandile.gif");
pokemonArray[551] = new pokemon("552", "", "Krokorok", "", "", "", "", "");
pokemonArray[552] = new pokemon("553", "", "Krookodile", "", "", "", "", "");
pokemonArray[553] = new pokemon("554", "", "Darumaka", "", "", "", "", "");
pokemonArray[554] = new pokemon("555", "✓", "Darmanitan", "Charlotte", "DexNav", 81, 174, "Shiny/darmanitan.gif");
pokemonArray[555] = new pokemon("556", "✓", "Maractus", "EvilTurnip", "DexNav", 71, 257, "Shiny/maractus.gif");
pokemonArray[556] = new pokemon("557", "✓", "Dwebble", "Doobie", "Friend Safari", 59, 1159, "Shiny/dwebble.gif");
pokemonArray[557] = new pokemon("558", "✓", "Crustle", "Lasaga", "Friend Safari", 184, 281, "Shiny/crustle.gif");
pokemonArray[558] = new pokemon("559", "✓", "Scraggy", "Turnip", "DexNav", 6, 992, "Shiny/scraggy.gif");
pokemonArray[559] = new pokemon("560", "✓", "Scrafty", "Kraft", "Hordes", 89, 62, "Shiny/scrafty.gif");
pokemonArray[560] = new pokemon("561", "✓", "Sigilyph", "Floatempole", "Friend Safari", 73, 191, "Shiny/sigilyph.gif");
pokemonArray[561] = new pokemon("562", "", "Yamask", "", "", "", "", "");
pokemonArray[562] = new pokemon("563", "", "Cofagrigus", "", "", "", "", "");
pokemonArray[563] = new pokemon("564", "", "Tirtouga", "", "", "", "", "");
pokemonArray[564] = new pokemon("565", "", "Carracosta", "", "", "", "", "");
pokemonArray[565] = new pokemon("566", "", "Archen", "", "", "", "", "");
pokemonArray[566] = new pokemon("567", "", "Archeops", "", "", "", "", "");
pokemonArray[567] = new pokemon("568", "✓", "Trubbish", "me irl", "DexNav", 60, 452, "Shiny/trubbish.gif");
pokemonArray[568] = new pokemon("569", "", "Garbodor", "", "", "", "", "");
pokemonArray[569] = new pokemon("570", "✓", "Zorua", "Mirage", "DexNav", 114, 16, "Shiny/zorua.gif");
pokemonArray[570] = new pokemon("571", "", "Zoroark", "", "", "", "", "");
pokemonArray[571] = new pokemon("572", "", "Minccino", "", "", "", "", "");
pokemonArray[572] = new pokemon("573", "", "Cinccino", "", "", "", "", "");
pokemonArray[573] = new pokemon("574", "", "Gothia", "", "", "", "", "");
pokemonArray[574] = new pokemon("575", "", "Gothorita", "", "", "", "", "");
pokemonArray[575] = new pokemon("576", "", "Gothitelle", "", "", "", "", "");
pokemonArray[576] = new pokemon("577", "", "Solosis", "", "", "", "", "");
pokemonArray[577] = new pokemon("578", "", "Duosion", "", "", "", "", "");
pokemonArray[578] = new pokemon("579", "", "Reuniclus", "", "", "", "", "");
pokemonArray[579] = new pokemon("580", "", "Ducklett", "", "", "", "", "");
pokemonArray[580] = new pokemon("581", "", "Swanna", "", "", "", "", "");
pokemonArray[581] = new pokemon("582", "✓", "Vanillite", "Ichigo", "Hordes", 127, 110, "Shiny/vanillite.gif");
pokemonArray[582] = new pokemon("583", "", "Vanillish", "", "", "", "", "");
pokemonArray[583] = new pokemon("584", "", "Vanilluxe", "", "", "", "", "");
pokemonArray[584] = new pokemon("585", "", "Deerling", "", "", "", "", "");
pokemonArray[585] = new pokemon("586", "✓", "Sawsbuck", "Buckette", "Friend Safari", 207, 398, "Shiny/sawsbuck.gif");
pokemonArray[586] = new pokemon("587", "✓", "Emolga", "Elesa", "Friend Safari", 128, 170, "Shiny/emolga.gif");
pokemonArray[587] = new pokemon("588", "", "Karrablast", "", "", "", "", "");
pokemonArray[588] = new pokemon("589", "", "Escavalier", "", "", "", "", "");
pokemonArray[589] = new pokemon("590", "✓", "Foongus", "Shroob", "Hordes", 78, 53, "Shiny/foongus.gif");
pokemonArray[590] = new pokemon("591", "", "Amoonguss", "", "", "", "", "");
pokemonArray[591] = new pokemon("592", "", "Frillish", "", "", "", "", "");
pokemonArray[592] = new pokemon("593", "", "Jellicent", "", "", "", "", "");
pokemonArray[593] = new pokemon("594", "", "Alomomola", "", "", "", "", "");
pokemonArray[594] = new pokemon("595", "✓", "Joltik", "Smol Spooder", "DexNav", 36, 533, "Shiny/joltik.gif");
pokemonArray[595] = new pokemon("596", "", "Galvantula", "", "", "", "", "");
pokemonArray[596] = new pokemon("597", "✓", "Ferroseed", "Burrito", "Friend Safari", 101, 82, "Shiny/ferroseed.gif");
pokemonArray[597] = new pokemon("598", "", "Ferrothorn", "", "", "", "", "");
pokemonArray[598] = new pokemon("599", "✓", "Klink", "Link", "DexNav", 141, 249, "Shiny/klink.gif");
pokemonArray[599] = new pokemon("600", "", "Klang", "", "", "", "", "");
pokemonArray[600] = new pokemon("601", "", "Klinklang", "", "", "", "", "");
pokemonArray[601] = new pokemon("602", "✓", "Tynamo", "Man Pollen", "DexNav", 69, 252, "Shiny/tynamo.gif");
pokemonArray[602] = new pokemon("603", "✓", "Eelektrik", "Boogaloo", "DexNav", 138, 171, "Shiny/eelektrik.gif");
pokemonArray[603] = new pokemon("604", "✓", "Eelektross", "Albatross", "DexNav", 139, 251, "Shiny/eelektross.gif");
pokemonArray[604] = new pokemon("605", "", "Elgyem", "", "", "", "", "");
pokemonArray[605] = new pokemon("606", "", "Beheeyem", "", "", "", "", "");
pokemonArray[606] = new pokemon("607", "", "Litwick", "", "", "", "", "");
pokemonArray[607] = new pokemon("608", "✓", "Lampent", "Cursed", "Friend Safari", 44, 666, "Shiny/lampent.gif");
pokemonArray[608] = new pokemon("609", "", "Chandelure", "", "", "", "", "");
pokemonArray[609] = new pokemon("610", "", "Axew", "", "", "", "", "");
pokemonArray[610] = new pokemon("611", "✓", "Fraxure", "Frasier", "Friend Safari", 112, 591, "Shiny/fraxure.gif");
pokemonArray[611] = new pokemon("611", "", "Haxorus", "", "", "", "", "");
pokemonArray[612] = new pokemon("612", "", "Cubchoo", "", "", "", "", "");
pokemonArray[613] = new pokemon("613", "", "Beartic", "", "", "", "", "");
pokemonArray[614] = new pokemon("614", "", "Cryogonal", "", "", "", "", "");
pokemonArray[615] = new pokemon("615", "", "Shelmet", "", "", "", "", "");
pokemonArray[616] = new pokemon("616", "", "Accelgor", "", "", "", "", "");
pokemonArray[617] = new pokemon("618", "✓", "Stunfisk", "Tully's", "Friend Safari", 67, 376, "Shiny/stunfisk.gif");
pokemonArray[618] = new pokemon("619", "✓", "Mienfoo", "Jackie Chan", "Friend Safari", 228, 1048, "Shiny/mienfoo.gif");
pokemonArray[619] = new pokemon("620", "", "Mienshao", "", "", "", "", "");
pokemonArray[620] = new pokemon("621", "", "Druddigon", "", "", "", "", "");
pokemonArray[621] = new pokemon("622", "", "Golett", "", "", "", "", "");
pokemonArray[622] = new pokemon("623", "", "Golurk", "", "", "", "", "");
pokemonArray[623] = new pokemon("624", "✓", "Pawniard", "SoFlo", "Friend Safari", 102, 262, "Shiny/pawniard.gif");
pokemonArray[624] = new pokemon("625", "", "Bisharp", "", "", "", "", "");
pokemonArray[625] = new pokemon("626", "✓", "Bouffalant", "Wings", "DexNav", 106, 310, "Shiny/bouffalant.gif");
pokemonArray[626] = new pokemon("627", "✓", "Rufflet", "Rowlet", "Friend Safari", 24, 1057, "Shiny/rufflet.gif");
pokemonArray[627] = new pokemon("628", "", "Braviary", "", "", "", "", "");
pokemonArray[628] = new pokemon("629", "", "Vullaby", "", "", "", "", "");
pokemonArray[629] = new pokemon("630", "", "Mandibuzz", "", "", "", "", "");
pokemonArray[630] = new pokemon("631", "", "Heatmor", "", "", "", "", "");
pokemonArray[631] = new pokemon("632", "✓", "Durant", "Kevin", "Hordes", 92, 140, "Shiny/durant.gif");
pokemonArray[632] = new pokemon("633", "", "Deino", "", "", "", "", "");
pokemonArray[633] = new pokemon("634", "", "Zweilous", "", "", "", "", "");
pokemonArray[634] = new pokemon("635", "", "Hydreigon", "", "", "", "", "");
pokemonArray[635] = new pokemon("636", "", "Larvesta", "", "", "", "", "");
pokemonArray[636] = new pokemon("637", "", "Volcarona", "", "", "", "", "");
pokemonArray[637] = new pokemon("638", "", "Cobalion", "", "", "", "", "");
pokemonArray[638] = new pokemon("639", "", "Terrakion", "", "", "", "", "");
pokemonArray[639] = new pokemon("640", "", "Virizion", "", "", "", "", "");
pokemonArray[640] = new pokemon("641", "", "Tornadus", "", "", "", "", "");
pokemonArray[641] = new pokemon("642", "", "Thundurus", "", "", "", "", "");
pokemonArray[642] = new pokemon("643", "✓", "Reshriam", "Jesus", "Soft-Reset", 236, 1661, "Shiny/reshiram.gif");
pokemonArray[643] = new pokemon("644", "✓", "Zekrom", "Usaine Bolt", "Soft-Reset", 142, 3043, "Shiny/zekrom.gif");
pokemonArray[644] = new pokemon("645", "", "Landorus", "", "", "", "", "");
pokemonArray[645] = new pokemon("646", "", "Kyurem", "", "", "", "", "");
pokemonArray[646] = new pokemon("647", "", "Keldeo", "", "", "", "", "");
pokemonArray[647] = new pokemon("648", "", "Meloetta", "", "", "", "", "");
pokemonArray[648] = new pokemon("649", "", "Genesect", "", "", "", "", "");
pokemonArray[649] = new pokemon("650", "", "Chespin", "", "", "", "", "");
pokemonArray[650] = new pokemon("651", "", "Quilladin", "", "", "", "", "");
pokemonArray[651] = new pokemon("652", "", "Chesnaught", "", "", "", "", "");
pokemonArray[652] = new pokemon("653", "", "Fennekin", "", "", "", "", "");
pokemonArray[653] = new pokemon("654", "✓", "Braixen", "Brexit", "Friend Safari", 54, 32, "Shiny/braixen.gif");
pokemonArray[654] = new pokemon("655", "", "Delphox", "", "", "", "", "");
pokemonArray[655] = new pokemon("656", "", "Froakie", "", "", "", "", "");
pokemonArray[656] = new pokemon("657", "", "Frogadier", "", "", "", "", "");
pokemonArray[657] = new pokemon("658", "", "Greninja", "", "", "", "", "");
pokemonArray[658] = new pokemon("659", "", "Bunnelby", "", "", "", "", "");
pokemonArray[659] = new pokemon("660", "✓", "Diggersby", "Thugs Bunny", "Friend Safari", 188, 108, "Shiny/diggersby.gif");
pokemonArray[660] = new pokemon("661", "", "Fletchling", "", "", "", "", "");
pokemonArray[661] = new pokemon("662", "", "Fletchinder", "", "", "", "", "");
pokemonArray[662] = new pokemon("663", "", "Talonflame", "", "", "", "", "");
pokemonArray[663] = new pokemon("664", "✓", "Scatterbug", "Albino", "PokeRadar", 118, 41, "Shiny/scatterbug.gif");
pokemonArray[664] = new pokemon("665", "", "Spewpa", "", "", "", "", "");
pokemonArray[665] = new pokemon("666", "✓", "Vivillon", "Vivian", "Friend Safari", 215, 1082, "Shiny/vivillon.gif");
pokemonArray[666] = new pokemon("667", "", "Litleo", "", "", "", "", "");
pokemonArray[667] = new pokemon("668", "✓", "Pyroar", "Nala", "Friend Safari", 240, 405, "Shiny/pyroar-f.gif");
pokemonArray[668] = new pokemon("669", "", "Flabébé", "", "", "", "", "");
pokemonArray[669] = new pokemon("670", "", "Floette", "", "", "", "", "");
pokemonArray[670] = new pokemon("671", "", "Florges", "", "", "", "", "");
pokemonArray[671] = new pokemon("672", "", "Skiddo", "", "", "", "", "");
pokemonArray[672] = new pokemon("673", "", "Gogoat", "", "", "", "", "");
pokemonArray[673] = new pokemon("674", "", "Pancham", "", "", "", "", "");
pokemonArray[674] = new pokemon("675", "", "Pangoro", "", "", "", "", "");
pokemonArray[675] = new pokemon("676", "", "Furfrou", "", "", "", "", "");
pokemonArray[676] = new pokemon("677", "✓", "Espurr", "Mob", "Friend Safari", 241, 1497, "Shiny/espurr.gif");
pokemonArray[677] = new pokemon("678", "", "Meowstic", "", "", "", "", "");
pokemonArray[678] = new pokemon("679", "", "Honedge", "", "", "", "", "");
pokemonArray[679] = new pokemon("680", "", "Doublade", "", "", "", "", "");
pokemonArray[680] = new pokemon("681", "", "Aegislash", "", "", "", "", "");
pokemonArray[681] = new pokemon("682", "", "Spritzee", "", "", "", "", "");
pokemonArray[682] = new pokemon("683", "", "Aromatisse", "", "", "", "", "");
pokemonArray[683] = new pokemon("684", "", "Swirlix", "", "", "", "", "");
pokemonArray[684] = new pokemon("685", "", "Slurpuff", "", "", "", "", "");
pokemonArray[685] = new pokemon("686", "", "Inkay", "", "", "", "", "");
pokemonArray[686] = new pokemon("687", "", "Malamar", "", "", "", "", "");
pokemonArray[687] = new pokemon("688", "", "Binacle", "", "", "", "", "");
pokemonArray[688] = new pokemon("689", "", "Barbaracle", "", "", "", "", "");
pokemonArray[689] = new pokemon("690", "✓", "Skrelp", "Zoidberg", "Breeding", 1, 2, "Shiny/skrelp.gif");
pokemonArray[690] = new pokemon("691", "", "Dragalge", "", "", "", "", "");
pokemonArray[691] = new pokemon("692", "", "Clauncher", "", "", "", "", "");
pokemonArray[692] = new pokemon("693", "", "Clawitzer", "", "", "", "", "");
pokemonArray[693] = new pokemon("694", "✓", "Helioptile", "Sunburn", "Friend Safari", 82, 126, "Shiny/helioptile.gif");
pokemonArray[694] = new pokemon("695", "✓", "Heliolisk", "Bernie", "Friend Safari", 83, 65, "Shiny/heliolisk.gif");
pokemonArray[695] = new pokemon("696", "", "Tyrunt", "", "", "", "", "");
pokemonArray[696] = new pokemon("697", "", "Tyrantrum", "", "", "", "", "");
pokemonArray[697] = new pokemon("698", "", "Amaura", "", "", "", "", "");
pokemonArray[698] = new pokemon("699", "", "Aurorus", "", "", "", "", "");
pokemonArray[699] = new pokemon("700", "✓", "Sylveon", "Cosmo", "DexNav", 13, 377, "Shiny/sylveon.gif");
pokemonArray[700] = new pokemon("701", "✓", "Hawlucha", "TinyWrestler", "Friend Safari", 185, 144, "Shiny/hawlucha.gif");
pokemonArray[701] = new pokemon("702", "", "Dedenne", "", "", "", "", "");
pokemonArray[702] = new pokemon("703", "✓", "Carbink", "Diancie?", "SOS Chain", 182, 250, "Shiny/carbink.gif");
pokemonArray[703] = new pokemon("704", "", "Goomy", "", "", "", "", "");
pokemonArray[704] = new pokemon("705", "", "Sliggoo", "", "", "", "", "");
pokemonArray[705] = new pokemon("706", "", "Goodra", "", "", "", "", "");
pokemonArray[706] = new pokemon("707", "✓", "Klefki", "Boo-Boo Keys", "Friend Safari", 226, 220, "Shiny/klefki.gif");
pokemonArray[707] = new pokemon("708", "", "Phantump", "", "", "", "", "");
pokemonArray[708] = new pokemon("709", "", "Trevenant", "", "", "", "", "");
pokemonArray[709] = new pokemon("710", "", "Pumpkaboo", "", "", "", "", "");
pokemonArray[710] = new pokemon("711", "", "Gourgeist", "", "", "", "", "");
pokemonArray[711] = new pokemon("712", "✓", "Bergmite", "Yellow Snow", "Friend Safari", 111, 9, "Shiny/bergmite.gif");
pokemonArray[712] = new pokemon("713", "✓", "Avalugg", "Coffee Table", "Friend Safari", 192, 367, "Shiny/avalugg.gif");
pokemonArray[713] = new pokemon("714", "✓", "Noibat", "Laylee", "Friend Safari", 237, 362, "Shiny/noibat.gif");
pokemonArray[714] = new pokemon("715", "", "Noivern", "", "", "", "", "");
pokemonArray[715] = new pokemon("716", "", "Xerneas", "", "", "", "", "");
pokemonArray[716] = new pokemon("717", "", "Yveltal", "", "", "", "", "");
pokemonArray[717] = new pokemon("718", "", "Zygarde", "", "", "", "", "");
pokemonArray[718] = new pokemon("719", "", "Diancie", "", "", "", "", "");
pokemonArray[719] = new pokemon("720", "", "Hoopa", "", "", "", "", "");
pokemonArray[720] = new pokemon("721", "", "Volcanion", "", "", "", "", "");
pokemonArray[721] = new pokemon("722", "✓", "Rowlet", "SPHERICAL", "Breeding", 168, 226, "Shiny/rowlet.gif");
pokemonArray[722] = new pokemon("723", "", "Dartrix", "", "", "", "", "");
pokemonArray[723] = new pokemon("724", "", "Decidueye", "", "", "", "", "");
pokemonArray[724] = new pokemon("725", "✓", "Litten", "ChairmanMeow", "Breeding", 171, 202, "Shiny/litten.gif");
pokemonArray[725] = new pokemon("726", "", "Torracat", "", "", "", "", "");
pokemonArray[726] = new pokemon("727", "", "Incineroar", "", "", "", "", "");
pokemonArray[727] = new pokemon("728", "✓", "Popplio", "Razzmatazz", "Breeding", 176, 364, "Shiny/popplio.gif");
pokemonArray[728] = new pokemon("729", "", "Brionne", "", "", "", "", "");
pokemonArray[729] = new pokemon("730", "", "Primarina", "", "", "", "", "");
pokemonArray[730] = new pokemon("731", "✓", "Pikipek", "Pearl", "SOS Chain", 164, 66, "Shiny/pikipek.gif");
pokemonArray[731] = new pokemon("732", "", "Trumbeak", "", "", "", "", "");
pokemonArray[732] = new pokemon("733", "", "Toucannon", "", "", "", "", "");
pokemonArray[733] = new pokemon("734", "✓", "Yungoos", "Lilac", "SOS Chain", 175, 26, "Shiny/yungoos.gif");
pokemonArray[734] = new pokemon("735", "", "Gumshoos", "", "", "", "", "");
pokemonArray[735] = new pokemon("736", "✓", "Grubbin", "Snackkin", "SOS Chain", 165, 191, "Shiny/grubbin.gif");
pokemonArray[736] = new pokemon("737", "", "Charjabug", "", "", "", "", "");
pokemonArray[737] = new pokemon("738", "", "Vikavolt", "", "", "", "", "");
pokemonArray[738] = new pokemon("739", "✓", "Crabrawler", "Meaty Claws", "SOS Chain", 167, 623, "Shiny/crabrawler.gif");
pokemonArray[739] = new pokemon("740", "", "Crabominable", "", "", "", "", "");
pokemonArray[740] = new pokemon("741", "✓", "Oricorio", "Flamencorio", "SOS Chain", 173, 66, "Shiny/oricorio.gif");
pokemonArray[741] = new pokemon("742", "✓", "Cutiefly", "Cutieful", "SOS Chain", 187, 534, "Shiny/cutiefly.gif");
pokemonArray[742] = new pokemon("743", "", "Ribombee", "", "", "", "", "");
pokemonArray[743] = new pokemon("744", "✓", "Rockruff", "Coral Blue", "SOS Chain", 166, 159, "Shiny/rockruff.gif");
pokemonArray[744] = new pokemon("745", "", "Lycanroc", "", "", "", "", "");
pokemonArray[745] = new pokemon("746", "✓", "Wishiwashi", "FlippyFloppy", "SOS Chain", 170, 102, "Shiny/wishiwashi.gif");
pokemonArray[746] = new pokemon("747", "", "Mareanie", "", "", "", "", "");
pokemonArray[747] = new pokemon("748", "", "Toxapex", "", "", "", "", "");
pokemonArray[748] = new pokemon("749", "✓", "Mudbray", "Kenneth", "SOS Chain", 177, 98, "Shiny/mudbray.gif");
pokemonArray[749] = new pokemon("750", "", "Mudsdale", "", "", "", "", "");
pokemonArray[750] = new pokemon("751", "✓", "Dewpider", "Dewriots", "SOS Chain", 169, 31, "Shiny/dewpider.gif");
pokemonArray[751] = new pokemon("752", "", "Araquanid", "", "", "", "", "");
pokemonArray[752] = new pokemon("753", "✓", "Fomantis", "Sick Grass", "SOS Chain", 234, 136, "Shiny/fomantis.gif");
pokemonArray[753] = new pokemon("754", "", "Lurantis", "", "", "", "", "");
pokemonArray[754] = new pokemon("755", "", "Morelull", "", "", "", "", "");
pokemonArray[755] = new pokemon("756", "", "Shiinotic", "", "", "", "", "");
pokemonArray[756] = new pokemon("757", "", "Salandit", "", "", "", "", "");
pokemonArray[757] = new pokemon("758", "", "Salazzle", "", "", "", "", "");
pokemonArray[758] = new pokemon("759", "", "Stufful", "", "", "", "", "");
pokemonArray[759] = new pokemon("760", "", "Bewear", "", "", "", "", "");
pokemonArray[760] = new pokemon("761", "", "Bounsweet", "", "", "", "", "");
pokemonArray[761] = new pokemon("762", "", "Steenee", "", "", "", "", "");
pokemonArray[762] = new pokemon("763", "✓", "Tsareena", "WoMangosteen", "SOS Chain", 174, 82, "Shiny/tsareena.gif");
pokemonArray[763] = new pokemon("764", "", "Comfey", "", "", "", "", "");
pokemonArray[764] = new pokemon("765", "", "Oranguru", "", "", "", "", "");
pokemonArray[765] = new pokemon("766", "", "Passimian", "", "", "", "", "");
pokemonArray[766] = new pokemon("767", "", "Wimpod", "", "", "", "", "");
pokemonArray[767] = new pokemon("768", "", "Golisopod", "", "", "", "", "");
pokemonArray[768] = new pokemon("769", "✓", "Sandygast", "Florida", "SOS Chain", 197, 638, "Shiny/sandygast.gif");
pokemonArray[769] = new pokemon("770", "", "Palossand", "", "", "", "", "");
pokemonArray[770] = new pokemon("771", "✓", "Pyukumuku", "Pukumber", "SOS Chain", 178, 244, "Shiny/pyukumuku.gif");
pokemonArray[771] = new pokemon("772", "", "Type: Null", "", "", "", "", "");
pokemonArray[772] = new pokemon("773", "", "Silvally", "", "", "", "", "");
pokemonArray[773] = new pokemon("774", "✓", "Minior", "Gordo", "Breeding", 183, 821, "Shiny/minior-violet.gif");
pokemonArray[774] = new pokemon("775", "", "Komala", "", "", "", "", "");
pokemonArray[775] = new pokemon("776", "", "Turtonator", "", "", "", "", "");
pokemonArray[776] = new pokemon("777", "", "Togedemaru", "", "", "", "", "");
pokemonArray[777] = new pokemon("778", "✓", "Mimikyu", "Bad Cosplay", "SOS Chain", 222, 114, "Shiny/mimikyu.gif");
pokemonArray[778] = new pokemon("779", "✓", "Bruxish", "Lip Service", "SOS Chain", 172, 104, "Shiny/bruxish.gif");
pokemonArray[779] = new pokemon("780", "", "Drampa", "", "", "", "", "");
pokemonArray[780] = new pokemon("781", "", "Dhelmise", "", "", "", "", "");
pokemonArray[781] = new pokemon("782", "", "Jangmo-o", "", "", "", "", "");
pokemonArray[782] = new pokemon("783", "", "Hakamo-o", "", "", "", "", "");
pokemonArray[783] = new pokemon("784", "", "Kommo-o", "", "", "", "", "");
pokemonArray[784] = new pokemon("785", "", "Tapu Koko", "", "", "", "", "");
pokemonArray[785] = new pokemon("786", "", "Tapu Lele", "", "", "", "", "");
pokemonArray[786] = new pokemon("787", "", "Tapu Bulu", "", "", "", "", "");
pokemonArray[787] = new pokemon("788", "", "Tapu Fini", "", "", "", "", "");
pokemonArray[788] = new pokemon("789", "", "Cosmog", "", "", "", "", "");
pokemonArray[789] = new pokemon("790", "", "Cosmoem", "", "", "", "", "");
pokemonArray[790] = new pokemon("791", "", "Solgaleo", "", "", "", "", "");
pokemonArray[791] = new pokemon("792", "", "Lunala", "", "", "", "", "");
pokemonArray[792] = new pokemon("793", "", "Nihilego", "", "", "", "", "");
pokemonArray[793] = new pokemon("794", "", "Buzzwole", "", "", "", "", "");
pokemonArray[794] = new pokemon("795", "", "Pheremosa", "", "", "", "", "");
pokemonArray[795] = new pokemon("796", "", "Xurkitree", "", "", "", "", "");
pokemonArray[796] = new pokemon("797", "", "Celesteela", "", "", "", "", "");
pokemonArray[797] = new pokemon("798", "", "Kartana", "", "", "", "", "");
pokemonArray[798] = new pokemon("799", "", "Guzzlord", "", "", "", "", "");
pokemonArray[799] = new pokemon("800", "", "Necrozma", "", "", "", "", "");
pokemonArray[800] = new pokemon("801", "", "Magearna", "", "", "", "", "");
pokemonArray[801] = new pokemon("802", "", "Marshadow", "", "", "", "", "");
}
